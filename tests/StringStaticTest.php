...
class StringStaticTest extends PHPUnit_Framework_TestCase
{
	...
	{
		$this->assertEquals('This is a Gears\Str.', Str::replace($this->string, 'string', 'Gears\Str'));
		$this->assertEquals($this->string, Str::replace($this->string, 'foo', 'Gears\Str'));
		$this->assertEquals('This is a Gears\Str.', Str::replace($this->string, '/string/', 'Gears\Str', true));
		$this->assertEquals($this->string, Str::replace($this->string, '/ string /', 'Gears\Str', true));
